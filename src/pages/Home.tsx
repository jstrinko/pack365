...
export default function Home() {
  return (
    <PageLayout>
      ...
      <section className="max-w-3xl mb-8 bg-white shadow-md rounded-2xl p-6 md:p-10 text-center">
        <JoinNowBlurb />
      </section>

      <section className="max-w-3xl w-full mb-8 justify-center flex">
      ...
      <section className="w-full mb-8 max-w-3xl">
      ...
      <section className="relative w-full max-w-3xl mx-auto overflow-hidden rounded-2xl shadow-lg max-w-3xl">
